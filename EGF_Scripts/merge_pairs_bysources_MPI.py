...
def main():
    ...
    CCFDIR    = os.path.join(rootpath+'_temp','CCF_SOURCES')                            # dir where CC data is stored
    MERGEDIR  = os.path.join(rootpath,'PAIRS_TWOSIDES')                          # dir where stacked data is going to
