...
# paths and filenames
rootpath = "data_wnacraton" # roothpath for the project
...
start_date = "2012_12_31_0_0_0"                               # start date of download
...
cc_len    = 6*3600                                                # basic unit of data length for fft (s)
step      = 3*3600                                                 # overlapping between each cc_len (s)
