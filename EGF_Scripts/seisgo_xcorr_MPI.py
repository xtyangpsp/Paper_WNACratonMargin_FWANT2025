...
rootpath  = "data_wnacraton"                                     # root path for this data processing
CCFDIR    = os.path.join(rootpath+"_temp",'CCF_SOURCES')                                    # dir to store CC data
...
maxlag         = 1200                                                        # lags of cross-correlation to save (sec)
...
if rank == 0:
    ...
    tdir = sorted(glob.glob(os.path.join(DATADIR,'2012*.h5')))
